...
namespace Sorge
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Dear user, you have made a mistake.\n" +
        ...
        {
            Console.WriteLine("Dear user, what do you want to be decypted");
            ...
            Console.WriteLine("Dear user, if the calculation is correct, you should have gotten 62314 and you actual result is: " + bookLocation);
            Console.WriteLine("If this is not the answer, THEN SOMETHING IS WRONG AND THE PROGRAM WILL NOT WORK AS INTENDED");
            Console.WriteLine("Now, as we are expected to open a book and whatnot, please, type in again the key you used for encryption.\n" +
            ...
            {
                Console.WriteLine("Dear user, you have inputted the wrong key as its length is not the same as the length of the message.\nPlease, try again: ");
        ...
        {
            Console.WriteLine("Dear user, what do you want to be encypted");
            ...
            Console.WriteLine("Dear user, at this point your code is turned into digits and the total number of digits is " + encryptedAfterTablification.ToString().Length + "\n" +
                              "The next part requires you to open a book and to input some numbers but for the sake of the algorithm " +
                              "please write an int EXACTLY as big as the number of digits of your message." +
                              "YOU CANNOT START WITH A '0', IT WILL BE DISCARDED");

            string newUserKey = Console.ReadLine();

            while (newUserKey.ToString().Length != encryptedAfterTablification.ToString().Length)
            {
                Console.WriteLine("Dear user, you have to input exactly " + encryptedAfterTablification.ToString().Length + " digits. " +
            ...
            Console.WriteLine("Dear user, now as another key we will need for you to assume that you have opened page 6, line 23, column 14, thus,\n" +
            ...
            Console.WriteLine("Dear user, this is your final encoding of your message: " + encryptedAfterTablification);
        }
        ...
        public static BigInteger EncyptWithDictionary(string toEncrypt)
        {
            ...
            {
                if (Char.IsLetter(toEncrypt[i]) || toEncrypt[i].Equals('/'))
                {
        ...
        public static string AddSlashes(string toEncrypt)
        {
            ...
            string[] messageAsArray = toEncrypt.Split(" ");
            foreach (string word in messageAsArray)
            {
